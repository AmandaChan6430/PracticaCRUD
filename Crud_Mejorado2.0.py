...
def login777():
    def comprobacion():
        ...
        if variable == FALSE:
            ...
            Button(ventana,bg="beige", text="Agregar jugador", command=ingresar_usuario).grid(row=7, column=3, padx=12, pady=10)
            Button(ventana, text="Actualizar jugador", command=actualizar_usuarioprincipal).grid(row=7, column=2, padx=8, pady=8)
            Button(ventana, text="Eliminar jugador", command=eliminar_usuarioprincipal).grid(row=7, column=1, padx=8, pady=6)
